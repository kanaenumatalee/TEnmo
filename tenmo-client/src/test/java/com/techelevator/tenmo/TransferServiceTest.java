...
public class TransferServiceTest {
    ...
    public void verify_view_transfer_history(){
        ...
        Assert.assertEquals(
            "Call to viewTransferHistory() didn't return the expected data.", 
            TEST_ID, 
