...
INSERT INTO tenmo_user (username, password_hash) VALUES ('Noah', 010101);
INSERT INTO tenmo_user (username, password_hash) VALUES ('Mio', 020202);

INSERT INTO account (user_id, balance)VALUES(1001, 900);
INSERT INTO account (user_id, balance)VALUES(1002, 1000);

INSERT INTO transfer_status (transfer_status_id, transfer_status_desc) VALUES (1, 'Pending');
INSERT INTO transfer_status (transfer_status_id, transfer_status_desc) VALUES (2, 'Approved');
INSERT INTO transfer_status (transfer_status_id, transfer_status_desc) VALUES (3, 'Rejected');

INSERT INTO transfer_type ( transfer_type_desc) VALUES ('Request');
INSERT INTO transfer_type (transfer_type_desc) VALUES ('Send');

INSERT INTO transfer (transfer_type_id, transfer_status_id, account_from, account_to, amount) VALUES (2, 1, 2002, 2001, 50);
INSERT INTO transfer (transfer_type_id, transfer_status_id, account_from, account_to, amount) VALUES (1, 3, 2001, 2002, 50);
